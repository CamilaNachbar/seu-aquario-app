 ...
 * super(new AntPathRequestMatcher(url)); setAuthenticationManager(authManager);
 * }
 * 
 ...
 * 
 * Usuario credentials = new ObjectMapper().readValue(request.getInputStream(),
 * Usuario.class);
 * 
 ...
 * HttpServletResponse response, FilterChain filterChain, Authentication auth)
